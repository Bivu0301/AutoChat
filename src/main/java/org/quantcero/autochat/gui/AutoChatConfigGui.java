...
public class AutoChatConfigGui extends GuiConfig{
    ...
    public AutoChatConfigGui(GuiScreen parentScreen) {
        super(parentScreen, new ConfigElement(AutoChat.config.getCategory(Configuration.CATEGORY_GENERAL)).getChildElements(), Constants.MODID, false, false, I18n.format("ac.tooltip"));
    }
